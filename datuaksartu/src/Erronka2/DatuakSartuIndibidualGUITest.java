...
public class DatuakSartuIndibidualGUITest {
	...
	public void testValidFileCreation() throws Exception {
		...
		String erabiltzaileaksartupath = JOptionPane
		...
		while (erabiltzaileaksartuizena == null || erabiltzaileaksartuizena.isEmpty()
				|| erabiltzaileaksartuizena.equals(".txt")) {
		...
		while (file.exists()) {
			erabiltzaileaksartuizena = JOptionPane
